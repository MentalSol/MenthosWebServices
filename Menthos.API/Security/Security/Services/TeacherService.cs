...
public class TeacherService : ITeacherService
{
    ...
    public async Task<AuthenticateResponse> Authenticate(AuthenticateRequest request)
    {
        ...
        Console.WriteLine($"User: {teacher.Id}, {teacher.Name}, {teacher.Lastname}, {teacher.Username}, {teacher.PasswordHash}");
        ...
        Console.WriteLine($"Response: {response.Id}, {response.Name}, {response.Lastname}, {response.Username}");
